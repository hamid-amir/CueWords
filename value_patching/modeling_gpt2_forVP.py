...
class GPT2SdpaAttention(GPT2Attention):
    ...
    def forward(
        ...
        # Start modyfing by Hamidreza
        if output_value_vectors:
            return attn_output, present, None, value_vectors
        return attn_output, present, None
        # Finish modyfing by Hamidreza
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        if not return_dict:
            return tuple(
                v
                for v in [hidden_states, presents, all_hidden_states, all_self_attentions, all_cross_attentions, all_value_vectors]  # Modified by Hamidreza
                if v is not None
            )
